...
public class ShowCardCtr : MonoBehaviour {
	...
	public bool ShowNext(){
		if(m_curIndex >= GameGlobalData.CardList.Length)
			return false;
		...
		m_cardList.Clear();
		for(int i=0; i<3; i++){
			if(m_curIndex+i < GameGlobalData.CardList.Length){
