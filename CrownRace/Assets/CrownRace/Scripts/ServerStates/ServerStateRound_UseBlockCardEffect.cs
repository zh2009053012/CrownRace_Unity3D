...
public class ServerStateRound_UseBlockCardEffect : Singleton<ServerStateRound_UseBlockCardEffect>, IStateBase {
	...
	public void Enter(GameStateBase owner)
	{
		...
		//更新玩家buff数据
		user.AddBuff(BUFF_EFFECT.BUFF_BLOCK_CARD, effectValue);
