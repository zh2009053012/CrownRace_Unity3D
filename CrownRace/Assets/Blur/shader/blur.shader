		...
		Pass {
			CGPROGRAM
				...
				half4 frag( v2f i ) : COLOR
				{
					...
					c += tex2D( _MainTex, i.uv+i.offuv[0]+half2(-0.01,0.01) )*_Weight1.x;
					c += tex2D( _MainTex, i.uv+i.offuv[1]+half2(-0.01,0.01) )*_Weight1.y;
					c += tex2D( _MainTex, i.uv+i.offuv[2]+half2(-0.01,0.01) )*_Weight1.z;
					c += tex2D( _MainTex, i.uv+i.offuv[3]+half2(-0.01,0.01) )*_Weight1.w;
					c += tex2D( _MainTex, i.uv+i.offuv[4]+half2(-0.01,0.01) )*_Weight2.x;
					c += tex2D( _MainTex, i.uv+i.offuv[5]+half2(-0.01,0.01) )*_Weight2.y;
					c += tex2D( _MainTex, i.uv+i.offuv[6]+half2(-0.01,0.01) )*_Weight2.z;
					c += tex2D( _MainTex, i.uv+i.offuv[7]+half2(-0.01,0.01) )*_Weight2.w;
